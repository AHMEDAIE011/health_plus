            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="form-elements">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"><a class="nav-link" href="add-cat.php">اضافه تصنيف</a></li>
                        <li class="nav-item"><a class="nav-link" href="add-item.php">اضافه منتج</a></li>
                    </ul>
                </div>
            </li>
            <li class="nav-item">
                ...
                <div class="collapse" id="tables">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"> <a class="nav-link" href="view-order.php">جدول الطلبات</a>
                        </li>
                        <li class="nav-item"> <a class="nav-link" href="view-user.php">جدول المستخدمين</a>
                        </li>
                    </ul>
                </div>
            </li>
